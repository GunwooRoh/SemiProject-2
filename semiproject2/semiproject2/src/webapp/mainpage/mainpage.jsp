  ...
  <!--<div class="header container clearfix">
    ...
    <header>
      ...
      <ul id="gnb">
        ...
        <li id="menubt">
          <a href="http://localhost:9090/semi2/eunjung/inc/mypage/profile.jsp" id="langKr">Mypage</a><a href="http://localhost:9090/semi2/eunjung/inc/Login/login.jsp" id="langEng">Login</a>
        </li>
      </ul>
    </header>
  </div>
